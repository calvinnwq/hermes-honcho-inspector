...
Session pages use a fixed upstream page size of 20 and a server-bounded page number.
...
Its Summarised only mode is a fixed server-owned view that checks only the 20 sessions on the selected page.
